...
#define STRING_CONFIG_H_AUTHOR "(Contrasens, Ender-3)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3
    ...
    #define DEFAULT_Kp_LIST {  32.32,  32.32 }
    #define DEFAULT_Ki_LIST {   3.25,   3.25 }
    #define DEFAULT_Kd_LIST {  80.35,  80.35 }
  #else
